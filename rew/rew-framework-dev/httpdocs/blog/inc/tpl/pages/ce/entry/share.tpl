		...
		<div id="content" class="-pad-vertical-lg column -width-1/1">
            <div id="social-network-panel" class="share-listing">
                <article class="mar-md">
                    <a class="share-link" title="Add to Facebook" href="javascript:var w = window.open('http://www.facebook.com/sharer.php?u=<?=urlencode(sprintf(URL_BLOG_ENTRY, $entry['link'])); ?>&amp;t=<?=urlencode($entry['title']); ?>', 'sharer', 'toolbar=0,status=0,scrollbars=1,width=660,height=400'); w.focus();">
                        ...
                        <div>Share this Post on Facebook</div>
                    </a>
                </article>
                <article class="mar-md">
                    <a class="share-link" title="Share on Twitter"  href="javascript:var w = window.open('http://twitter.com/home?status=<?=urlencode('Check out this blog post: ' . sprintf(URL_BLOG_ENTRY, $entry['link']));?>', 'twittersharer', 'toolbar=0,status=0,scrollbars=1,width=400,height=325'); w.focus();">
                        <svg width="80px" height="80px" viewBox="0 0 150 150">
                            <title>Twitter</title>
                        ...
                        <div>Tweet this Post on Twitter</div>
                    </a>
                </article>
                <article class="mar-md">
                    <a class="share-link" title="Share on Google+" href="javascript:var w = window.open('https://plusone.google.com/share?url=<?=urlencode(sprintf(URL_BLOG_ENTRY, $entry['link'])); ?>', 'gplusshare', 'toolbar=0,status=0,scrollbars=1,width=600,height=450'); w.focus();">
                        <svg width="80px" height="80px" viewBox="-71 -71 150 150">
                            <title>Google Plus</title>
                            <desc>Share this Post on Google plus</desc>
                        ...
                        <div>Share this Post on Google+</div>
                    </a>
                </article>
                <article class="mar-md">
                    <a class="share-link" title="Send to Friend" href="mailto:?subject=Listing%20from%20dev.cenext-qa.rewdev.com%20-%20551%20S%20Gulfview%20Blvd&amp;body=While%20searching%20for%20property%20on%20http%3A%2F%2Fdev.cenext-qa.rewdev.com%2Fidx%2F%2C%20I%20thought%20you%20might%20be%20interested%20in%20the%20following%20property%20MLS%C2%AE%20%23U7821541.%0D%0A%0D%0AThe%20URL%20below%20will%20take%20you%20to%20the%20property%27s%20details%3A%0D%0Ahttp%3A%2F%2Fdev.cenext-qa.rewdev.com%2Flisting%2Fu7821541-551-s-gulfview-blvd-clearwater-beach-fl-33767%2F&amp;popup">
                        <svg width="80px" height="80px" viewBox="-71 -71 150 150">
                            <title>Email</title>
                        ...
                        <div>Send a link to this Post via Email.</div>
                    </a>
                </article>
            </div>
        </div>
