...
<div id="<?=$this->getUID(); ?>">
    ...
    <div class="-clear -mar-vertical">

        <div class="section section-b -pad-0">
            <div class="body">
                <form>
                    ...
                    <div class="-pad">
                        ...
                        <div id="eval-step-location">
							<div class="input -pill">
                            	<input id="<?=$this->getUID(); ?>-ac" class="ac-search -pill" name="adr" value="<?=Format::htmlspecialchars($_GET['adr']); ?>"<?=(empty($_GET['adr']) ? ' autofocus' : ''); ?>>
                                <button class="ac-locate btn -pill -text-upper btn--strong">Locate</button>
							</div>
                        </div>
                    ...
                    <div class="body-b">
                        ...
                        <?php if (!empty($idx_subtypes)) { ?>
                            <div class="field column -width-1/1 hidden">
        ...
        <div class="section section-a -pad-0">
    ...
    <?php if ($this->config('cta')) { ?>
        <div class="signup -mar-vertical">
            <?=($photo = $this->config('cta.photo')) ? '<img class="pleft" data-src="' . Format::htmlspecialchars($photo) . '" alt="">' : ''; ?>
            
                <?=($heading = $this->config('cta.heading')) ? '<h3>' . Format::htmlspecialchars($heading) . '</h3>' : ''; ?>
                <?=($content = $this->config('cta.content')) ? '<p>' . $content . '</p>' : ''; ?>
                <?=($button = $this->config('cta.button')) ? '<div class="buttons"><a class="cta-link button button-pill button--strong">' . Format::htmlspecialchars($button) . '</a></div>' : ''; ?>
    ...
    <?php if ($this->config('results')) { ?>
        <div class="matches hidden">
            ...
            <div class="listings columns -pad-bottom-lg"></div>
        </div>
    <?php } ?>
