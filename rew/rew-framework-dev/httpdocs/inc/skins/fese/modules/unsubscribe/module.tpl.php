<?php if (empty($_POST['unsubscribe']) && empty($_GET['d'])) { ?>
    ...
    <form method="post">
        ...
        <div class="btns">
            <button class="btn btn--primary" value="Unsubscribe" name="send" type="submit">Unsubscribe</button>
        </div>
...
<?php } else if (!empty($data) && empty($_POST['subscribe'])) { ?>
    ...
    <form method="post">
        ...
        <div class="buttons">
            <button class="button" value="Confirm Account" name="send" type="submit">Confirm Account</button>
        </div>
