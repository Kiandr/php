    ...
    $.Window({
        ...
        onOpen: function (win) {
            var criteria = search, $el = win.getWindow(), $msg = $el.find('.msg'), $form = $el.find('form').on('submit', function () {
                $msg.removeClass('msg--pos msg--neg').addClass('msg--note').html('Processing Request...');
                ...
                $.ajax({
                    ...
                    success: function (json, textStatus) {
                        ...
                        if (json.success) {
                            $msg.html(json.success + '<br />').addClass('msg--pos').removeClass('msg--note');
                            ...
                            if (json.error) {
                                $msg.html(json.error).addClass('msg--neg').removeClass('msg--note');
                            }
                            if (json.redirect) {
                                $.Window({
