...
<div id="<?=$this->getUID(); ?>" class="property-valuation">
				...
				<form>
					...
					<div class="body-a">
						...
						<div id="eval-step-location">
							...
							<div class="btnset">
								<button class="ac-locate">Locate</button>
							</div>
						</div>
	...
	<?php if ($this->config('cta')) { ?>
		<div class="signup">
			...
			<div class="body">
				...
				<?=($button = $this->config('cta.button')) ? '<div class="btnset"><a class="cta-link btn strong">' . Format::htmlspecialchars($button) . '</a></div>' : ''; ?>
			</div>
		</div>
	<?php } ?>
	...
	<?php if ($this->config('results')) { ?>
		<div class="matches hidden">
			...
			<div class="articleset colset listings gridded"></div>
		</div>
	<?php } ?>
