<?php if (!empty($results)) { ?>
    ...
    <div class="articleset">
        <?php foreach ($results as $result) { ?>
            <article>
                <a href="<?= Format::htmlspecialchars($result['url_details']); ?>">
                    <img src="<?= Format::htmlspecialchars($placeholder); ?>" data-src="<?= Format::htmlspecialchars($result['ListingImage']); ?>" alt="<?= Format::htmlspecialchars($result['Address']); ?>" />
