	...
	<div class="wrap">
		<div class="feature-video-main">
			<div class="l-align section-photo">
				<img class="realtor-photo" src="<?= Format::htmlspecialchars($skin->getUrl()); ?>/img/agent.png" alt="">
			</div>
					...
					<div class="video-container">
						<?php if (!empty($video_id)) { ?>
							<?php if (stripos($video_id, 'vimeo') === false) { ?>
								<iframe width="275" height="155" src="https://www.youtube.com/embed/<?= Format::htmlspecialchars($video_id); ?>?rel=0&amp;controls=0&amp;showinfo=0&amp;modestbranding=1" frameborder="0" allowfullscreen></iframe>
							<?php } else { ?>
								<iframe width="275" height="155" src="<?= Format::htmlspecialchars($video_id); ?>" frameborder="0" allowfullscreen></iframe>
							<?php } ?>
						<?php } ?>
					</div>
