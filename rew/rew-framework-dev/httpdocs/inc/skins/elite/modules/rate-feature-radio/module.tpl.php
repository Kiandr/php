<div class="module">
    <div class="wrap">
        <div class="feature-radio-main">
            <div id="feature-radio">
                <div class="radio-feature-head">
                    <span class="radio-icon">
                        <svg width="28" height="49" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 283.8 504" enable-background="new 0 0 283.8 504" xml:space="preserve">
                            <g>
                                <path fill="red" d="M252.3,220.2v47.3c0,61-49.4,110.4-110.4,110.4c-61,0-110.4-49.4-110.4-110.4v-47.3H0v47.3
                                    c0,73,55.2,133.2,126.2,141v64H63.1V504h63.1h31.5h63.1v-31.5h-63.1v-64c71-7.8,126.2-68,126.2-141v-47.3H252.3z" />
                                <path fill="red" d="M178.4,88.5h42.4V78.3c0-25.9-12.5-48.9-31.8-63.3v35c0,5.3-4.4,9.7-9.7,9.7s-9.7-4.4-9.7-9.7V4.4
                ...
                <div class="radio-container">
                    <?php if (!empty($radio)) { ?>
                        <?php foreach ($radio as $ad) { ?>
                            <div class="radio-spot">
                                <div class="radio-image">
                                    <?php if (!empty($ad['image'])) { ?>
                                        <img src="/uploads/<?= Format::htmlspecialchars($ad['image']); ?>" alt="">
                                    <?php } ?>
                                </div>
                                <div class="radio-title">
                                    <?php if (!empty($ad['title'])) { ?>
                                        <?= Format::htmlspecialchars($ad['title']); ?>
                                    <?php } ?>
                                </div>
