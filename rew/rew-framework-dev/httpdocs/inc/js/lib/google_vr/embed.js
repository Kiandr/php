...
VRDisplay.prototype.fireVRDisplayConnect_ = function() {
  ...
  // CustomEvent custom fields all go under e.detail (so the VRDisplay ends up
  // being e.detail.display, instead of e.display as per WebVR spec).
  // REWMOD - Hack fix to get this working in IE11
...
function WebVRPolyfill() {
  ...
  // REWMOD - removed conditional - fix for IE/Edge/FF
...
LoadingIndicator.prototype.build_ = function() {
  ...
  s.background = '#eee';
  var img = document.createElement('img');
  // REWMOD - custom image dir
  img.src = '/inc/skins/ce/img/google-vr-loading.gif';
  var s = img.style;
  s.position = 'absolute';
  s.top = '50%';
  s.left = '50%';
...
SphereRenderer.prototype.setPhotosphere = function(src, opt_params) {
  return new Promise(function(resolve, reject) {
    ...
    // REWMOD - change "anonymous" to "use-credentials"
...
WorldRenderer.prototype.setDefaultYaw_ = function(angleRad) {
  ...
  // REWMOD - check if display exists
  if (display) {
