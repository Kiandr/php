...
class Http_Response
{
    ...
    /**
     * Key-value array of HTTP response headers
     * @var array
     */
    ...
    /**
     * Manages Cookies to be sent with this Response
     * @var CookieJar
     */
    protected $cookieJar;
     ...
     * @return void
     */
    public function __construct(Http_Request $req)
    {
        $this->request = $req;
     ...
     * Set Cookie Jar
     *
     * @param   Http_CookieJar $cookieJar
     * @return  void
     */
    public function setCookieJar(Http_CookieJar $cookieJar)
    {
