<div id="directory-add" class="rew-directory">
	...
	<form action="?submit" method="post" enctype="multipart/form-data" class="uk-form uk-form-stacked uk-margin-large-top">
		<div class="uk-grid">
			<div class="uk-width-1-2 uk-margin-bottom" data-uk-margin>
				...
				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					...
					<input name="business_name" class=".uk-width-* uk-form-large" value="<?=Format::htmlspecialchars($_POST['business_name']); ?>" required>
				</div>

				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-address" class="uk-form-label"> Street Address </label>
					<input id="business-address" class=".uk-width-* uk-form-large" name="address" value="<?=Format::htmlspecialchars($_POST['address']); ?>">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-city" class="uk-form-label"> City </label>
					<input id="business-city" class=".uk-width-* uk-form-large" name="city" value="<?=Format::htmlspecialchars($_POST['city']); ?>">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-state" class="uk-form-label"> <?=Locale::spell('State'); ?> </label>
					<input id="business-state" class=".uk-width-* uk-form-large" name="state" value="<?=Format::htmlspecialchars($_POST['state']); ?>">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-zipcode" class="uk-form-label"> <?=Locale::spell('Zip Code'); ?> </label>
					<input id="business-zipcode" class=".uk-width-* uk-form-large" name="zip" value="<?=Format::htmlspecialchars($_POST['zip']); ?>">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-website" class="uk-form-label"> Website </label>
					<input id="business-website" class=".uk-width-* uk-form-large" type="url" name="website" value="<?=Format::htmlspecialchars($_POST['website']); ?>" placeholder="http://www.mywebsite.com/">
				</div>
			...
			<div class="uk-width-1-2 uk-margin-bottom" data-uk-margin>
				...
				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					...
					<input id="business-primary-phone" class=".uk-width-* uk-form-large" type="tel" name="phone" value="<?=Format::htmlspecialchars($_POST['phone']); ?>" placeholder="123-456-7890">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-secondary-phone" class="uk-form-label"> Secondary Phone </label>
					<input id="business-secondary-phone" class=".uk-width-* uk-form-large" type="tel" name="alt_phone" value="<?=Format::htmlspecialchars($_POST['alt_phone']); ?>" placeholder="123-456-7890">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-tollfree" class="uk-form-label"> Toll Free </label>
					<input id="business-tollfree" class=".uk-width-* uk-form-large" type="tel" name="toll_free" value="<?=Format::htmlspecialchars($_POST['toll_free']); ?>" placeholder="123-456-7890">
				</div>

				<div class="uk-width-small-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-fax" class="uk-form-label"> Fax </label>
					<input id="business-fax" class=".uk-width-* uk-form-large" type="tel" name="fax" value="<?=Format::htmlspecialchars($_POST['fax']); ?>" placeholder="123-456-7890">
				</div>
			...
			<div class="uk-grid uk-width-1-1 uk-margin-bottom" data-uk-margin="">
				...
				<div class="uk-width-1-1 uk-margin-bottom">
					...
					<input id="business-category-other" class=".uk-width-* uk-form-large" name="other_category" value="<?=Format::htmlspecialchars($_POST['other_category']); ?>">
				...
				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					...
					<textarea id="listing-description" class="uk-width-1-1 uk-form-large" name="description" cols="32" rows="6"><?=Format::htmlspecialchars($_POST['description']); ?></textarea>
			...
			<div class="uk-grid uk-width-1-1 uk-margin-bottom" data-uk-margin>
				...
				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					...
					<input id="business-contact-name" class=".uk-width-* uk-form-large" name="contact_name" value="<?=Format::htmlspecialchars($_POST['contact_name']); ?>" required="">
				</div>

				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-contact-phone" class="uk-form-label"> Phone <small class="required">*</small></label>
					<input id="business-contact-phone" class=".uk-width-* uk-form-large" type="tel" name="contact_phone" value="<?=Format::htmlspecialchars($_POST['contact_phone']); ?>">
				</div>

				<div class="uk-width-1-1 uk-margin-bottom uk-margin-small-top">
					<label for="business-contact-email" class="uk-form-label"> Email <small class="required">*</small></label>
					<input id="business-contact-email" class=".uk-width-* uk-form-large" type="email" name="contact_email" value="<?=Format::htmlspecialchars($_POST['contact_email']); ?>">
				</div>
			...
			<div class="uk-width-1-1">
				<button type="submit" class="uk-button uk-button-medium" role="button"> Add Business </button>
			</div>
		</div>
	</form>
