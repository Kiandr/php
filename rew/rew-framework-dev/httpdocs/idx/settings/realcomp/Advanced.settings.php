...
if (!function_exists('realcomp_parse_listing')) {
	function realcomp_parse_listing (IDX $idx, Database $db_idx, $listing) {
...
if (!function_exists('realcomp_search_fields')) {

	function realcomp_search_fields($idx, $filter = '', $comparison = false)  {
