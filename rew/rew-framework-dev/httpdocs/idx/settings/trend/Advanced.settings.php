...
if (!function_exists('trend_parse_listing')) {
    function trend_parse_listing (IDX $idx, Database $db_idx, $listing) {

		// Fix broken entities
		$listing['ListingOffice'] = str_replace('&apos;', '\'', $listing['ListingOffice']);
...
if (!function_exists('trend_search_fields')) {

    function trend_search_fields($idx, $filter = '', $comparison = false)  {
