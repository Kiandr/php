...
if (!function_exists('carets_search_criteria')) {

	function carets_search_criteria($idx, $request = array())  {

		// Remove hyphens from MLS #
		if (!empty($request['search_mls'])) {
			$request['search_mls'] = str_replace('-', '', $request['search_mls']);
		}
...
if (!function_exists('carets_search_fields')) {

    function carets_search_fields($idx, $filter = '', $comparison = false)  {
