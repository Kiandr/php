...
$_DETAILS[] = array('heading' => 'Essential Information', 'fields' => array(
                ...
                array('value' => 'DescriptionSqFtSource',           'title' => 'Square Footage Source'),
                array('value' => 'NumberOfAcres',                   'title' => 'Acres',              'format' => 'number_format2'),
                array('value' => 'YearBuilt',                       'title' => 'Year Built'),
                array('value' => 'YearRemodeled',                   'title' => 'Year Remodeled'),
...
$_DETAILS[] = array('heading' => 'Interior', 'fields' => array(
                ...
                array('value' => 'HasBasement',                     'title' => 'Has Basement',         'format' => 'enum_YN'),
                array('value' => 'DescriptionBasement',             'title' => 'Basement'),
                ...
                array('value' => 'DescriptionLofts',                'title' => 'Lofts'),
            ));
...
$_DETAILS[] = array('heading' => 'Additional Information', 'fields' => array(
                array('value' => 'ListingDate',                     'title' => 'Date Listed',          'format' => 'date_format'),
                array('value' => 'ListingDOM',                      'title' => 'Days on Market'),
                ...
                array('value' => 'DescriptionHOAFees',              'title' => 'HOA Fees'),
                array('value' => 'DescriptionHOAFeesFrequency',     'title' => 'HOA Fees Freq.'),
                array('value' => 'DescriptionDeedRestrictions',     'title' => 'Deed Restrictions'),
                array('value' => 'DescriptionLegal',                'title' => 'Legal'),
                array('value' => 'DescriptionDisclosures',          'title' => 'Disclosures'),
                array('value' => 'ListingTaxes',                    'title' => 'Taxes'),
                array('value' => 'ListingTaxYear',                  'title' => 'Tax Year'),
                array('value' => 'DescriptionTransferTax',          'title' => 'Real Estate Transfer Tax'),
            ));
