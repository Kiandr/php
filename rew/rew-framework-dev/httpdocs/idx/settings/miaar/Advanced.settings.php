...
if (!function_exists('miaar_parse_listing')) {
	function miaar_parse_listing (IDX $idx, Database $db_idx, $listing) {

		// Clean Bathroom Number - Compliance Requested
		$listing['NumberOfBathrooms'] = rtrim($listing['NumberOfBathrooms'], '.0');
...
if (!function_exists('miaar_search_fields')) {

	function miaar_search_fields($idx, $filter = '', $comparison = false)  {
		...
		$IDX_SEARCH_FIELDS = array(
				...
				array('name' => 'Min. Rent',           'form_field' => 'minimum_rent',          'idx_field' => 'ListingPrice',          'match' => 'morethan'),
				array('name' => 'Max. Rent',           'form_field' => 'maximum_rent',          'idx_field' => 'ListingPrice',          'match' => 'lessthan'),
