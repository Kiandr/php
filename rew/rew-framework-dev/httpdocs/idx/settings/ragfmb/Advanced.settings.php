...
if (!function_exists('ragfmb_search_fields')) {

	function ragfmb_search_fields($idx, $filter = '', $comparison = false)  {
        ...
        $IDX_SEARCH_FIELDS = array(
            ...
            // Feed Specific Field
            array('name' => 'Gulf Access',         'form_field' => 'search_gulfaccess',     'idx_field' => 'IsGulfAccess',          'match' => 'equals'),
        );
