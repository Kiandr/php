...
if (!function_exists('ntreisvow_search_fields')) {

    function ntreisvow_search_fields($idx, $filter = '', $comparison = false)  {

        $IDX_SEARCH_FIELDS = array(
            array('name' => 'MLS Number'		, 'form_field' => 'search_mls'			, 	'idx_field' => 'ListingMLS'			, 	'match' => 'equals'									),
            array('name' => 'Property Type'		, 'form_field' => 'search_type'			, 	'idx_field' => 'ListingType'		, 	'match' => 'equals'		, 'group' => 'Property Type'),            
            array('name' => 'Stories'			, 'form_field' => 'search_stories'		, 	'idx_field' => 'NumberOfStories'	, 	'match' => 'equals'									),
            array('name' => 'Style'				, 'form_field' => 'search_style'		, 	'idx_field' => 'ListingStyle'		, 	'match' => 'equals'									),
            array('name' => 'Property Sub-Type'	, 'form_field' => 'search_subtype'		, 	'idx_field' => 'ListingSubType'		, 	'match' => 'findinset'	, 'group' => 'Property Type'),
            ...
            array('name' => 'Foreclosure',        'form_field' => 'search_foreclosure',    	'idx_field' => 'IsForeclosure',         'match' => 'equals'),
            array('name' => 'Short Sale',         'form_field' => 'search_shortsale',      	'idx_field' => 'IsShortSale',           'match' => 'equals'),
            array('name' => 'Bank Owned',         'form_field' => 'search_bankowned',      	'idx_field' => 'IsBankOwned',           'match' => 'equals'),
