...
$CONNECTION['settings']['host'] = 'idxdb-gaaar.gce.rewhosting.com';
$CONNECTION['settings']['user'] = 'dev_rewtemp';
$CONNECTION['settings']['pass'] = 'rCg529aO28Utosn0';
$CONNECTION['settings']['db']   = 'rewidx_gaaar_' . $client_db_suffix;

// Add to Database Collection
array_push($DATABASE, array('name' => 'gaaar', 'settings' => $CONNECTION['settings']));
