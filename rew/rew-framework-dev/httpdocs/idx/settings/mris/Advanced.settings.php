...
if (!function_exists('mris_parse_listing')) {
    function mris_parse_listing (IDX $idx, Database $db_idx, $listing) {

        // HTML Entity Decode
        $listing['ListingRemarks'] = str_replace('&apos;', '\'', $listing['ListingRemarks']);
        $listing['ListingRemarks'] = html_entity_decode($listing['ListingRemarks'], ENT_QUOTES, 'UTF-8');
...
if (!function_exists('mris_search_fields')) {

    function mris_search_fields($idx, $filter = '', $comparison = false)  {
