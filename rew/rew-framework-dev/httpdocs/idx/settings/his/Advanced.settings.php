...
if (!function_exists('his_search_fields')) {

	function his_search_fields($idx, $filter = '', $comparison = false)  {

        $IDX_SEARCH_FIELDS = array(
            array('name' => 'MLS Number',          'form_field' => 'search_mls',            'idx_field' => 'ListingMLS',            'match' => 'equals'),
            array('name' => 'Property Type',       'form_field' => 'search_type',           'idx_field' => 'ListingType',           'match' => 'findinset'),
