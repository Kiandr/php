...
if (!function_exists('triad_parse_listing')) {
	function triad_parse_listing (IDX $idx, Database $db_idx, $listing) {

		// Compliance requirement - must show range instead
		$listing['NumberOfSqFt'] = !empty($listing['NumberOfSqFtDisplay']) ? $listing['NumberOfSqFtDisplay'] : '';
...
if (!function_exists('triad_search_fields')) {

	function triad_search_fields($idx, $filter = '', $comparison = false)  {
