...
$CONNECTION['settings']['host'] = 'idxdb-iglbor.gce.rewhosting.com';
$CONNECTION['settings']['user'] = 'dev_rewtemp';
$CONNECTION['settings']['pass'] = 'rCg529aO28Utosn0';
$CONNECTION['settings']['db']   = 'rewidx_iglbor_' . $client_db_suffix;

// Add to Database Collection
array_push($DATABASE, array('name' => 'iglbor', 'settings' => $CONNECTION['settings']));
                                                                                                                                                                                                                                        // Clear Memory
unset($CONNECTION);
