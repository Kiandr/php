...
if (!function_exists('waar_search_fields')) {

	function waar_search_fields($idx, $filter = '', $comparison = false)  {
        ...
        $IDX_SEARCH_FIELDS = array(
            ...
            array('name' => 'Office Name',         'form_field' => 'office',                'idx_field' => 'ListingOffice',         'match' => 'equals'),
            ...
            array('name' => 'Foreclosure',         'form_field' => 'search_foreclosure',    'idx_field' => 'IsForeclosure',         'match' => 'equals', 'group' => 'special'),
            array('name' => 'Short Sale',          'form_field' => 'search_shortsale',      'idx_field' => 'IsShortSale',           'match' => 'equals', 'group' => 'special'),
            array('name' => 'Bank Owned',          'form_field' => 'search_bankowned',      'idx_field' => 'IsBankOwned',           'match' => 'equals', 'group' => 'special'),
