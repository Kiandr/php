...
if (!function_exists('ecar_search_fields')) {

	function ecar_search_fields($idx, $filter = '', $comparison = false)  {
		...
		$IDX_SEARCH_FIELDS = array(
            ...
            array('name' => 'Min. Days on Website', 'form_field' => 'minimum_dom',           'idx_field' => 'ListingDOM',            'match' => 'morethan'),
            array('name' => 'Max. Days on Website', 'form_field' => 'maximum_dom',           'idx_field' => 'ListingDOM',            'match' => 'lessthan'),
