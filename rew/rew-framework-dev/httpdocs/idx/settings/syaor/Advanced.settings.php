...
if (!function_exists('syaor_parse_listing')) {
    function syaor_parse_listing (IDX $idx, Database $db_idx, $listing) {
		// Combine Office and Agent for Compliance
		if (!empty($listing['ListingOffice'])) {			
			$listing['ListingOffice'] = $listing['ListingAgent'] . ' Of ' . $listing['ListingOffice'];
		}
...
if (!function_exists('syaor_search_fields')) {

	function syaor_search_fields($idx, $filter = '', $comparison = false)  {
