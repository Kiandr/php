...
if (!function_exists('ereb_parse_listing')) {
    function ereb_parse_listing (IDX $idx, Database $db_idx, $listing) {

        // MLS Requirement: Must Show Agent for EREB Listings
        if (stripos($listing['ListingMLS'], 'e') === 0) {
			$listing['ListingOffice'] = 'Courtesy Of '.$listing['ListingAgent'].' Of '.$listing['ListingOffice'];
        }
...
if (!function_exists('ereb_search_fields')) {

    function ereb_search_fields($idx, $filter = '', $comparison = false)  {
