...
// Feed Settings
if (empty(Settings::getInstance()->SETTINGS['map_latitude']))  Settings::getInstance()->SETTINGS['map_latitude']  = 53.5435640;
if (empty(Settings::getInstance()->SETTINGS['map_longitude'])) Settings::getInstance()->SETTINGS['map_longitude'] = -113.4904520;
...
// Remove lang header on idx popups
Lang::$lang['IDX_DETAILS_MAP_PAGE_TITLE'] = '';
