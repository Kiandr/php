...
$CONNECTION['settings']['host'] = 'idxdb-fkmls.gce.rewhosting.com';
$CONNECTION['settings']['user'] = 'dev_rewtemp2';
$CONNECTION['settings']['pass'] = 'rCg529aO28Utosn0';
$CONNECTION['settings']['db']   = 'rewidx_fkmls_' . $client_db_suffix;

// Add to Database Collection
array_push($DATABASE, array('name' => 'fkmls', 'settings' => $CONNECTION['settings']));
