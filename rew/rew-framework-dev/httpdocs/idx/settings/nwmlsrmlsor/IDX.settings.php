...
$IDX_RESOURCE = array(
    'settings' => array(
        'name'     => 'nwmlsrmlsor',
        'database' => 'nwmlsrmlsor',
        'table'    => '_rewidx_listings',
        'commingled' => true,
        'feeds'    => array('nwmls', 'rmls_or'),
        'search_where_callback' => function ($alias, $idx) {
            // Comingled Agent Subdomain Compliance
            return \Container::getInstance()->get(\REW\Core\Interfaces\IDX\ComplianceInterface::class)->agentSubdomainFilterComingled($alias, $idx);
        }
    ),
    'fields'   => array(
