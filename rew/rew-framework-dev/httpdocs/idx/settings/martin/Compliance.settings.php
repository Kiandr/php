...
$_COMPLIANCE['results']['show_icon'] = '<img alt="Realtorimg srcreg; Association of Martin County, Inc. MLS Logo" src="' . Settings::getInstance()->SETTINGS['URL_IMG'] . 'logos/martin-th.jpg" border="0" width="95" height="35" style="width:95px; height:35px;" />'; // width and height are min requirements
