...
$CONNECTION['settings']['host'] = 'idxdb-fmaar.gce.rewhosting.com';
$CONNECTION['settings']['user'] = 'dev_rewtemp';
$CONNECTION['settings']['pass'] = 'rCg529aO28Utosn0';
$CONNECTION['settings']['db']   = 'rewidx_fmaar_' . $client_db_suffix;

// Add to Database Collection
array_push($DATABASE, array('name' => 'fmaar', 'settings' => $CONNECTION['settings']));
