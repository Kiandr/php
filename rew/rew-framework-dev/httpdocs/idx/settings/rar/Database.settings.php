...
$CONNECTION['settings']['host'] = 'idxdb-rar.gce.rewhosting.com';
$CONNECTION['settings']['user'] = 'dev_rewtemp';
$CONNECTION['settings']['pass'] = 'rCg529aO28Utosn0';
$CONNECTION['settings']['db']   = 'rewidx_rar_' . $client_db_suffix;

// Add to Database Collection
array_push($DATABASE, array('name' => 'rar', 'settings' => $CONNECTION['settings']));
