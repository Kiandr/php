...
if (!function_exists('naborftp_combined_search_fields')) {

	function naborftp_combined_search_fields($idx, $filter = '', $comparison = false)  {
        ...
        $IDX_SEARCH_FIELDS = array(
            ...
            array('name' => 'Foreclosure',         'form_field' => 'search_foreclosure',    'idx_field' => 'IsForeclosure',         'match' => 'equals', 'group' => ((isset($_REQUEST['search_foreclosure']) && $_REQUEST['search_foreclosure'] != 'N') ? 'special' : null)),
            array('name' => 'Short Sale',          'form_field' => 'search_shortsale',      'idx_field' => 'IsShortSale',           'match' => 'equals', 'group' => ((isset($_REQUEST['search_shortsale']) && $_REQUEST['search_shortsale']   != 'N') ? 'special' : null)),
            array('name' => 'Bank Owned',          'form_field' => 'search_bankowned',      'idx_field' => 'IsBankOwned',           'match' => 'equals', 'group' => ((isset($_REQUEST['search_bankowned']) && $_REQUEST['search_bankowned']   != 'N') ? 'special' : null)),
