...
if (!function_exists('cmlssc_search_fields')) {

	function cmlssc_search_fields($idx, $filter = '', $comparison = false)  {
...
//            array('name' => 'Max. Days on Market', 'form_field' => 'maximum_dom',           'idx_field' => 'ListingDOM',            'match' => 'lessthan'),
			array('name' => 'Min. Days on Website', 'form_field' => 'minimum_dow',           'idx_field' => 'ListingDOW',            'match' => 'morethan'),
			array('name' => 'Max. Days on Website', 'form_field' => 'maximum_dow',           'idx_field' => 'ListingDOW',            'match' => 'lessthan'),
