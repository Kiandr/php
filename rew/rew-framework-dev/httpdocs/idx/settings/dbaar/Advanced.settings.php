...
if (!function_exists('dbaar_search_fields')) {

	function dbaar_search_fields($idx, $filter = '', $comparison = false)  {
        ...
        $IDX_SEARCH_FIELDS = array(
            ...
            // Feed Specific Field
            array('name' => 'Condo Name',          'form_field' => 'search_condoname',      'idx_field' => 'CondoName',             'match' => 'equals'),
        );
