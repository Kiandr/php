...
if (in_array($_GET['load_page'], array('search', 'search_map', 'details', 'map', 'streetview', 'birdseye', 'directions', 'local', 'brochure', '', 'dashboard'))) {
	...
	// Details Logo
	$_COMPLIANCE['disclaimer'][] = '<p class="disclaimer"><img alt="Real Estate Board of Greater Vancouver (Commercial) Logo" src="' . Settings::getInstance()->SETTINGS['URL_IMG'] . 'logos/mlsrlogo.gif" /></p>';

}

// Search Results, Display Thumbnail Icon
$_COMPLIANCE['results']['show_icon'] = '<img alt="Real Estate Board of Greater Vancouver (Commercial) Logo" src="' . Settings::getInstance()->SETTINGS['URL_IMG'] . 'logos/mlsrlogosmall.png" border="0" />';
...
if (in_array($_GET['load_page'], array('details', 'brochure', 'streetview', 'birdseye'))) {
...
// Brochure logo
$_COMPLIANCE['logo'] = Settings::getInstance()->SETTINGS['URL_IMG'] . 'logos/mlsrlogo.gif';     // Path
