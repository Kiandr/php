...
if (!function_exists('hcmls_parse_listing')) {
	function hcmls_parse_listing (IDX $idx, Database $db_idx, $listing) {

    	// Clean Up Phone numbers
   		$phone = (isset($listing['ListingOfficePhone']))? preg_replace("/[^0-9]/", "", $listing['ListingOfficePhone']) : '';
        switch (strlen($phone)) {
		    case 7:
        ...
        // Prepend Phone # to Listing Office
        $listing['ListingOffice'] = !empty($listing['ListingOffice']) ? $listing['ListingOffice'] . ' ' . $phone : '';
...
if (!function_exists('hcmls_search_fields')) {

	function hcmls_search_fields($idx, $filter = '', $comparison = false)  {
