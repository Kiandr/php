...
if (!function_exists('bridgemls_parse_listing')) {
	function bridgemls_parse_listing (IDX $idx, Database $db_idx, $listing) {

        // Remove SqFt from Map Search
        if (in_array($_GET['load_page'], array('search_map'))) {
            unset($listing['NumberOfSqFt']);
        }
...
if (!function_exists('bridgemls_search_fields')) {

	function bridgemls_search_fields($idx, $filter = '', $comparison = false)  {
