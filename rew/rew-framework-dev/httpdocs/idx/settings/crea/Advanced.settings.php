...
if (!function_exists('crea_images')) {
        function crea_images (IDX $idx, Database $db_idx, $listing, $thumbnails = false) {
                $images = array();
                if ($thumbnails) {
...
if (!function_exists('crea_search_fields')) {

	function crea_search_fields($idx, $filter = '', $comparison = false)  {
