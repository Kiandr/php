...
<template>
  <div class="thumb-wrap">
    ...
    <div v-else-if="context.length" :class="`${thumb.baseClass} ${color_class} ${modifier_classes}`" class="thumb-text-center">{{ text }}
    </div>

    <div v-else-if="!src && !context.length" :class="`${thumb.baseClass}`" class="thumb-r thumb-text-center">
      <slot>
...
<style lang="scss" scoped>
    :root {
        ...
        --thumb-large-size-multiplier: 1.25;
    }
