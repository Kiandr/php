...
/**
 * Lead Group Unassign Controller
...
class Unassign implements ControllerInterface
{
    ...
    /**
     * Unssign the requested lead from the requested groups
     *
     * @throws ServerSuccessException
     * @return void
     */
    protected function unassignGroups()
    {
        foreach ($this->groups as $group) {
            $this->lead->removeGroup($group, $this->auth);
        }

        // If we've made it this far the call was successful
        throw new ServerSuccessException('The lead has been successfully unassigned from the requested groups.');
    }
}
