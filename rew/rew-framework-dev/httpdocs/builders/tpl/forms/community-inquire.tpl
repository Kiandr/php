...
<div class="community-inquire-wrap">
	...
	<?php if ($show_form) { ?>
		...
		<h4>Ask a Real Estate Professional for more info about <?=$community['SubdivisionName'];?></span></h4>

		<div class="bdx-inquire-form">
	
			<form method="post" action="?submit" id='framew_tpl_community_inquire'>
				...
				<input type="hidden" name="community_id" value="<?=$community['SubdivisionID'];?>">
