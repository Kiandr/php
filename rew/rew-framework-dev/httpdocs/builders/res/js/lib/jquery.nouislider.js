    ...
    $.fn.noUiSlider = function( options ){
        ...
        var
		 ...
		 doc = $(document)
            ...
            ,clsList = [
                ...
                /*  3 */ ,'bdx-noUi-input'
                /*  4 */ ,'bdx-noUi-active'
                /*  5 */ ,'bdx-noUi-state-tap'
                /*  6 */ ,'bdx-noUi-target'
                /*  7 */ ,'-lower'
                /*  8 */ ,'-upper'
                /*  9 */ ,'bdx-noUi-connect'
                /* 10 */ ,'bdx-noUi-vertical'
                /* 11 */ ,'bdx-noUi-horizontal'
                /* 12 */ ,'bdx-noUi-background'
                /* 13 */ ,'bdx-noUi-z-index'
                /* 14 */ ,'bdx-noUi-block'
                /* 15 */ ,'bdx-noUi-state-blocked'
                /* 16 */ ,'bdx-noUi-rtl'
            ]
        ...
        function attach ( events, target, callback, scope, noAbstraction ) {
            ...
            return target.on( events, $.proxy( function( e ){
                ...
                if( this.target.hasClass('bdx-noUi-state-tap') ||
