<h2 id="leads-create">Create a new lead</h2>

<p><code>POST http://<?=$_SERVER['HTTP_HOST'];?>/api/crm/v1/leads</code></p>

<p>
	Creating a lead will add it to the Lead Management system. Once created, the lead's e-mail address can be used in other requests
	such as creating a history event.
</p>

<p>
	The <a href="#responses">response</a> of this request contains the <a href="#lead">Lead</a> object that was created.
</p>
