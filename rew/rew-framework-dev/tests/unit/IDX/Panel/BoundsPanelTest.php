...
class BoundsPanelTest extends \Codeception\Test\Unit
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $expectedTitle = 'Search in Bounds';

    /**
     * @var string
     */
    protected $expectedTooltip = 'Search only mappable listings within the map\'s bounds.';
    ...
    /**
     * @covers IDX_Panel_Bounds::__construct()
     */
    public function testConstruct()
    {
        ...
        // Mock Panel class
        $panel = new IDX_Panel_Bounds($options);
        $this->assertEquals(
            $options['tooltip'],
            $panel->getTooltip(),
    ...
    {
        // Mock Panel class
        $panel = Mockery::mock(IDX_Panel_Bounds::class)->makePartial();
    ...
    /**
     * @covers IDX_Panel_Bounds::getTags()
     */
    public function testGetTags()
    {
        $value = 1;
        $expectedTagTitle = 'Within Map Boundaries';
        $expectedTagField = ['bounds' => 1];
