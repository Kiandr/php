...
class RadiusPanelTest extends \Codeception\Test\Unit
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $expectedTitle = 'Radius Search';

    /**
     * @var string
     */
    protected $expectedTooltip = 'Click on the map to draw your radius search.';

    /**
     * @var string
     */
    protected $expectedControlId = 'GRadiusControl';
    ...
    /**
     * @covers IDX_Panel_Radius::__construct()
     */
    public function testConstruct()
    {
        ...
        // Mock Panel class
        $panel = new IDX_Panel_Radius($options);
        $this->assertEquals(
            $options['tooltip'],
            $panel->getTooltip(),
    ...
    {
        // Mock Panel class
        $panel = Mockery::mock(IDX_Panel_Radius::class)->makePartial();
    ...
    /**
     * @covers IDX_Panel_Radius::getTags()
     */
    public function testGetTags()
    {
        $value = 1;
        $expectedTagTitle = 'In Radius';
        $expectedTagField = ['radius' => 1];
